...
## v3.8.1  /  20260905-audit-fix

- Package imports ใช้ relative พร้อม fallback แบบ sys.path เดิม
- evaluate_decision บังคับ DQ gate → INSUFFICIENT ไม่ให้เป็น CANDIDATE
- scanner.decide() เป็น decision engine ชุดเดียวกับ payload
- payload เตือนเมื่อ scanner._regime ยังไม่ถูก set
- FCF conversion ไม่ให้คะแนนเมื่อ OCF/FCF ติดลบ

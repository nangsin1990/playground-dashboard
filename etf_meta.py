...
ETF_META = {
    ...
    "SCHD": {"name":"Schwab US Dividend Equity ETF",       "cat":"Broad Market",  "sub":"US Dividend",     "index":"Dow Jones US Div 100", "er":0.06,  "aum":57,   "desc":"หุ้นปันผลสูง คุณภาพดี ค่าธรรมเนียมถูก"},
    ...
    "SPXU": {"name":"ProShares UltraPro Short S&P 500",    "cat":"Leveraged",     "sub":"S&P 500 3x Bear", "index":"S&P 500 x-3",          "er":0.90,  "aum":0.5,  "desc":"Short S&P 500 3เท่า ของ ProShares"},
    ...
    "IBIT": {"name":"iShares Bitcoin Trust",               "cat":"Crypto",        "sub":"Spot Bitcoin",    "index":"Bitcoin Spot",         "er":0.25,  "aum":50,   "desc":"ถือบิตคอยน์จริง ไม่ใช่ฟิวเจอร์ส"},
    "SOXX": {"name":"iShares Semiconductor ETF",           "cat":"Sector",        "sub":"Semiconductors",  "index":"ICE Semiconductor",    "er":0.35,  "aum":14,   "desc":"เซมิคอนดักเตอร์แบบ market cap"},
    "IGV":  {"name":"iShares Expanded Tech-Software ETF",  "cat":"Sector",        "sub":"Software",        "index":"S&P North Am Software","er":0.41,  "aum":10,   "desc":"ซอฟต์แวร์ CRM NOW ADBE"},
    "BOTZ": {"name":"Global X Robotics & AI ETF",          "cat":"Thematic",      "sub":"Robotics & AI",   "index":"Indxx Robotics & AI",  "er":0.69,  "aum":3,    "desc":"หุ่นยนต์และปัญญาประดิษฐ์"},
    "ROBO": {"name":"Robo Global Robotics ETF",            "cat":"Thematic",      "sub":"Robotics",        "index":"ROBO Global Robotics",  "er":0.95,  "aum":1,    "desc":"หุ่นยนต์และออโตเมชัน"},
    "ARKW": {"name":"ARK Next Generation Internet ETF",    "cat":"Thematic",      "sub":"Next Gen Internet","index":"Active Managed",      "er":0.75,  "aum":2,    "desc":"อินเทอร์เน็ตรุ่นใหม่ของ ARK"},
    "ARKF": {"name":"ARK Fintech Innovation ETF",          "cat":"Thematic",      "sub":"Fintech",         "index":"Active Managed",       "er":0.75,  "aum":1,    "desc":"ฟินเทคของ ARK"},
    "ARKX": {"name":"ARK Space Exploration ETF",           "cat":"Thematic",      "sub":"Space",           "index":"Active Managed",       "er":0.75,  "aum":0.3,  "desc":"อวกาศและดาวเทียมของ ARK"},
    "XAR":  {"name":"SPDR S&P Aerospace & Defense ETF",    "cat":"Sector",        "sub":"Aerospace",       "index":"S&P Aerospace Defense","er":0.35,  "aum":3,    "desc":"อากาศยานและกลาโหม equal weight"},
    "ITA":  {"name":"iShares U.S. Aerospace & Defense ETF","cat":"Sector",        "sub":"Aerospace",       "index":"Dow Jones US Aero Def","er":0.40,  "aum":7,    "desc":"อากาศยานและกลาโหมสหรัฐ"},
    "LIT":  {"name":"Global X Lithium & Battery Tech ETF", "cat":"Thematic",      "sub":"Lithium Battery", "index":"Solactive Lithium",    "er":0.75,  "aum":2,    "desc":"ลิเธียมและแบตเตอรี่"},
    "COPX": {"name":"Global X Copper Miners ETF",          "cat":"Commodity",     "sub":"Copper Miners",   "index":"Solactive Copper Miners","er":0.65, "aum":2,    "desc":"เหมืองทองแดง"},
    "SIL":  {"name":"Global X Silver Miners ETF",          "cat":"Commodity",     "sub":"Silver Miners",   "index":"Solactive Silver Miners","er":0.65,"aum":1,    "desc":"เหมืองเงิน"},
    "REMX": {"name":"VanEck Rare Earth/Strategic Metals",  "cat":"Commodity",     "sub":"Rare Earths",     "index":"MVIS Rare Earth",      "er":0.54,  "aum":0.5,  "desc":"แร่หายากและโลหะยุทธศาสตร์"},
    "IJR":  {"name":"iShares Core S&P Small-Cap ETF",      "cat":"Broad Market",  "sub":"US Small Cap",    "index":"S&P SmallCap 600",     "er":0.06,  "aum":85,   "desc":"สมอลแคปคุณภาพใน S&P 600"},
    "IJH":  {"name":"iShares Core S&P Mid-Cap ETF",        "cat":"Broad Market",  "sub":"US Mid Cap",      "index":"S&P MidCap 400",       "er":0.05,  "aum":90,   "desc":"มิดแคป S&P 400"},
    "IWO":  {"name":"iShares Russell 2000 Growth ETF",     "cat":"Broad Market",  "sub":"Small Growth",    "index":"Russell 2000 Growth",  "er":0.24,  "aum":11,   "desc":"สมอลแคปโกรทใน Russell 2000"},
    "IWN":  {"name":"iShares Russell 2000 Value ETF",      "cat":"Broad Market",  "sub":"Small Value",     "index":"Russell 2000 Value",   "er":0.24,  "aum":11,   "desc":"สมอลแคปแวลูใน Russell 2000"},
    "VTWO": {"name":"Vanguard Russell 2000 ETF",           "cat":"Broad Market",  "sub":"US Small Cap",    "index":"Russell 2000",         "er":0.10,  "aum":11,   "desc":"Russell 2000 ค่าธรรมเนียมถูกกว่า IWM"},
    "VB":   {"name":"Vanguard Small-Cap ETF",              "cat":"Broad Market",  "sub":"US Small Cap",    "index":"CRSP US Small Cap",    "er":0.05,  "aum":55,   "desc":"สมอลแคปกว้างของ Vanguard"},
    "SCHA": {"name":"Schwab U.S. Small-Cap ETF",           "cat":"Broad Market",  "sub":"US Small Cap",    "index":"Dow Jones US Small Cap","er":0.04, "aum":17,   "desc":"สมอลแคปค่าธรรมเนียมต่ำ"},
    "IWF":  {"name":"iShares Russell 1000 Growth ETF",     "cat":"Broad Market",  "sub":"US Growth",       "index":"Russell 1000 Growth",  "er":0.19,  "aum":95,   "desc":"โกรทขนาดใหญ่-กลาง"},
    "IWD":  {"name":"iShares Russell 1000 Value ETF",      "cat":"Broad Market",  "sub":"US Value",        "index":"Russell 1000 Value",   "er":0.19,  "aum":60,   "desc":"แวลูขนาดใหญ่-กลาง"},
    "QUAL": {"name":"iShares MSCI USA Quality Factor ETF", "cat":"Broad Market",  "sub":"US Quality",      "index":"MSCI USA Quality",     "er":0.15,  "aum":50,   "desc":"หุ้นคุณภาพสูงสหรัฐ"},
    "MOAT": {"name":"VanEck Morningstar Wide Moat ETF",    "cat":"Broad Market",  "sub":"US Quality",      "index":"Morningstar Wide Moat","er":0.47,  "aum":15,   "desc":"หุ้นคูเมืองกว้างของ Morningstar"},
    "MTUM": {"name":"iShares MSCI USA Momentum Factor ETF","cat":"Broad Market",  "sub":"US Momentum",     "index":"MSCI USA Momentum",    "er":0.15,  "aum":15,   "desc":"โมเมนตัมขนาดใหญ่สหรัฐ"},
    "SPMO": {"name":"Invesco S&P 500 Momentum ETF",        "cat":"Broad Market",  "sub":"US Momentum",     "index":"S&P 500 Momentum",     "er":0.13,  "aum":8,    "desc":"โมเมนตัมใน S&P 500"},
    "JEPI": {"name":"JPMorgan Equity Premium Income ETF",  "cat":"Broad Market",  "sub":"Covered Call",    "index":"Active Managed",       "er":0.35,  "aum":35,   "desc":"รายได้จาก covered call บนหุ้นใหญ่"},
    "JEPQ": {"name":"JPMorgan Nasdaq Premium Income ETF",  "cat":"Broad Market",  "sub":"Covered Call",    "index":"Active Managed",       "er":0.35,  "aum":25,   "desc":"รายได้จาก covered call บน Nasdaq"},
    "QQQI": {"name":"NEOS Nasdaq-100 High Income ETF",     "cat":"Broad Market",  "sub":"Covered Call",    "index":"Active Managed",       "er":0.68,  "aum":4,    "desc":"รายได้สูงบน Nasdaq-100"},
    "MAGS": {"name":"Roundhill Magnificent Seven ETF",     "cat":"Thematic",      "sub":"Magnificent 7",   "index":"Equal Mag7",           "er":0.29,  "aum":2,    "desc":"เจ็ดหุ้นใหญ่เทคโนโลยีแบบเท่ากัน"},
    "MCHI": {"name":"iShares MSCI China ETF",              "cat":"International", "sub":"China",           "index":"MSCI China",           "er":0.59,  "aum":6,    "desc":"จีนทั้งตลาดรวม ADR"},
    "VWO":  {"name":"Vanguard FTSE Emerging Markets ETF",  "cat":"International", "sub":"Broad EM",        "index":"FTSE Emerging",        "er":0.08,  "aum":90,   "desc":"ตลาดเกิดใหม่ค่าธรรมเนียมต่ำ"},
    "EWY":  {"name":"iShares MSCI South Korea ETF",        "cat":"International", "sub":"Korea",           "index":"MSCI Korea",           "er":0.58,  "aum":5,    "desc":"ตลาดหุ้นเกาหลี"},
    "EWT":  {"name":"iShares MSCI Taiwan ETF",             "cat":"International", "sub":"Taiwan",          "index":"MSCI Taiwan",          "er":0.58,  "aum":5,    "desc":"ตลาดหุ้นไต้หวัน เน้น TSM"},
}

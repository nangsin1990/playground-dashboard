...
def calculate_rrg_metrics(
    ...
    """JdK-style RRG: RS-Ratio = 100 * RS / SMA(RS), RS-Momentum = 100 * Ratio / Ratio.shift(n)."""
    results = {}
    ...
    sma = rel.rolling(RRG_SMOOTHING, min_periods=RRG_ROLL_MIN).mean()
    jrs_val = 100.0 * (rel / sma)
    jmo_val = 100.0 * (jrs_val / jrs_val.shift(period))

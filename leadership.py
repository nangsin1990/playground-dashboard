...
def build_leadership_board(mode: str) -> dict:
    ...
    out = {
        ...
        "universe_listed_core": (pack.get("dash") or {}).get("universe_listed_core"),
        "universe_listed_full": (pack.get("dash") or {}).get("universe_listed_full"),
        "universe_loaded": len(combined),
        "universe_total": (pack.get("dash") or {}).get("universe_total") or len(combined),
        "universe_listed": (pack.get("dash") or {}).get("universe_listed"),
    }

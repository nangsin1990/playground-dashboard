...
# ── Pre-warm scheduler ────────────────────────────────────────────────────────
# ยิง load_market_pack("full") ล่วงหน้าเป็นระยะ กัน user เจอ cold-cache เอง
# ตั้งให้สั้นกว่า CACHE_TTL_DATA เล็กน้อยเพื่อ refresh ก่อนหมดอายุพอดี
PREWARM_INTERVAL_SEC = 14 * 60   # 14 min (TTL คือ 15 min)
PREWARM_MODES = ("full", "core")

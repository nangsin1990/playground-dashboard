...
#v6.2: Yahoo batch/concurrency profile locked for speed
#"""
...
LB_ACCUM_LOOKBACK   = 21
LB_TIGHTNESS_WEEKS  = 6
LB_UD_RATIO_LOOKBACK= 21
LB_VOL_WINDOW       = 51
...
LB_RS_LEADER_MIN    = 70
LB_RS_ELITE         = 80
LB_RS_LAGGARD_MAX   = 40
LB_RS_FADE_MAX      = 50
LB_OFF_LOW_MIN      = 25.0
LB_OFF_HIGH_MAX     = 25.0
LB_TEMPLATE_MIN     = 7
...
# ── Pipeline / Universe ───────────────────────────────────────────────────────
# v5.4: 10→25 — batch 10 ทำให้ full universe (~1071 ticker ในลิสต์) แตกเป็นหลายสิบ batches/คิว
...
# ไม่ prewarm full (~1071 ตัวในลิสต์) เพราะกด Yahoo หนักถ้าเปิดค้างทั้งวัน
